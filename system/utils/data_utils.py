...
def read_server_testset(dataset, q=0.2, batch_size=64):
    ...
    """
    if dataset not in ["MNIST", "FashionMNIST", "Cifar10", "Cifar100"]:  # "MNIST", "Cifar10", "FashionMNIST"
        # 主要是莎士比亚等数据集，原本的代码里有专门的处理，所以加一个这个限制
        print("read_server_testset还没处理非MNIST, FashionMNIST, Cifar10, Cifar100外的数据集，请检查")
